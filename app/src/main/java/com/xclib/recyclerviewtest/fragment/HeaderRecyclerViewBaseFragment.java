...
protected XCRate ieView xcRecycleView;
        proteate in extends Fragment{

        priv nt scrollXValue=0;
        privecyclt scrollYValue=0;
...
public abstract class HeaderRecyclerViewBaseFragment
